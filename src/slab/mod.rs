...
pub const SIZE_CLASSES: [usize; 35] = [
    16, 24, 32, 48, 64, 80, 96, 128, 160, 192, 256, 320, 384, 512, 768, 1024, 1280, 1536, 1792,
    2048, 3072, 3840, 4096, 6144, 8192, 12288, 16384, 24576, 32768, 65536, 131072, 262144, 524288,
    1048576, 2097152,
];
...
pub const ITERATIONS: [usize; 35] = [
    // Tiny (16B-128B)
    512, 256, 256, 128, 128, 64, 64, 64, // Small (160B-512B)
